...
<head>
	...
	<script src="../JQuery/queryRoles.js"></script>
		...
		<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #ff5050;">
      		...
      		<div class="collapse navbar-collapse" id="navbarSupportedContent">
        		<div class="navbar-nav">
     				...
     				<a class="nav-item nav-link" href="../Parametros/parametros.html">Parametros</a>
      			...
      			<div class="col-md-5">
          			<div class="card">
            			<div class="card-body">
              				...
              				<form id="form-roles">
              					<input type="hidden" id="idRol"><!--Valor id-->
                				<div class="form-group">
                  					<input type="text" id="nombreRol" placeholder="Nombre del Rol" class="form-control">
                				</div>
                				<div class="form-group">
