...
<head>
  ...
  <meta charset="utf-8">
	...
	<script src="../JQuery/querySemestres.js"></script>
		...
		<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #ff5050;">
      		...
      		<div class="collapse navbar-collapse" id="navbarSupportedContent">
        		<div class="navbar-nav">
            		...
            		<a class="nav-item nav-link active" href="#">Semestres</a>
      			...
      			<div class="col-md-5">
          			<div class="card">
            			<div class="card-body">
              				...
              				<form id="form-semestres">
              					<input type="hidden" id="semestreId"><!--Valor id-->
                				<div class="form-group">
                  					<input type="text" id="semestre" placeholder="Ingrese Nombre Semestre" class="form-control">
                				</div>                
